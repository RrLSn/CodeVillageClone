  ...
  return (
    <body className="App">
      <header className="cdIntro lg:w-[99vw] lg:h-[160vh] h-[350vh] w-full">
        ...
        <h1 className='lg:text-8xl text-7xl font-[550] lg:w-[42rem] w-[30rem] lg:pl-[8rem] px-[3rem] text-[#18214d]'>We build world class Tech talents</h1>
      ...
      <div className='w-[99vw] lg:h-[130vh] h-[400vh] lg:mt[0rem] mt-[5rem] bg-[#eff2f6] grid lg:grid-cols-2 grid-rows-2 lg:p-[5rem] p-[3rem]'>
        <div className='lg:my-[7rem] mb-[15rem] h-[70vh] my-[2rem]'>
        ...
        <div className='lg:ml-[10rem] lg:programme h-[max-content] lg:mt-[7rem] lg:pl-[3rem]'>
      ...
      <div className='w-[99vw] lg:h-[70vh] h-[150vh] text-center pt-[5rem] lg:px-[] px-[3rem]'>
        ...
        <p className='lg:text-[1.2rem] text-2xl'>Will your kids be able to build a tech solution? Yes, It’s possible.</p>
        <p className='lg:text-[1.2rem] text-2xl lg:w-[42rem] w-[21rem] m-[auto]'>“We catch them young” by introducing these fresh minds into how computer works and how to make it do what they want.</p>
      ...
      <div className='w-[99vw] h-[max-content] bg-[#f4f8f6] lg:px-[8rem] px-[6rem] pt-[7rem] flex flex-col gap-[3rem]'>
        <div className='grid lg:grid-cols-4 gap-[3rem]'>
          <div>
            <img className='lg:w-[12rem] w-[15rem]' src="/media/cv-logo.svg" alt="" />
            <p className='lg:text-[1.2rem] text-[2rem] lg:w-[10rem] w-[20rem] mt-[1.5rem] font-[370]'>Building the tech talents for the future of work.</p>
          </div>

          <div>
            <h1 className='lg:h1-info lg:text-[1.3rem] font-[700] text-[2.5rem] mb-[1.8rem]'>Our Programs</h1>
            <p className='lg:text-[1.2rem] text-[2rem] w-[12rem] mt-[1rem] font-[350]'>Fullstack Training</p>
            <p className='lg:text-[1.2rem] text-[2rem] lg:w-[10rem] w-[16rem] mt-[0.5rem] font-[350]'>Kids & Teens Code Classes</p>
          </div>

          <div>
            <h1 className='lg:h1-info font-[700] lg:text-[1.3rem] text-[2.5rem] mb-[1.8rem]'>Links</h1>
            <p className='lg:text-[1.2rem] text-[2rem] w-[10rem] mt-[0.5rem] font-[370]'>Careers</p>
            <p className='lg:text-[1.2rem] text-[2rem] lg:w-[10rem] w-full mt-[0.5rem] font-[370]'>Refund Policy</p>
            <p className='lg:text-[1.2rem] text-[2rem] lg:w-[10rem] w-full mt-[0.5rem] font-[370]'>Privacy Policy</p>
          </div>
          
          <div>
            <h1 className='lg:h1-info font-[700] lg:text-[1.3rem] text-[2.5rem] mb-[1.8rem]'>Contacts</h1>
            <p className='lg:text-[1.2rem] text-[2rem] lg:w-[12rem] w-[20rem] mt-[1rem] mb-[1rem] font-[370]'>Rasak Onilu Plaza (Middle Floor), Adjacent Niger Motel, Niger Road, Ilorin, Nigeria</p>
            <h1 className='lg:h1-info font-[700] lg:text-[1.3rem] text-[2rem] w-full mb-[1.8rem]'>08168861541 (Nigeria)</h1>
            <h1 className='lg:h1-info font-[700] lg:text-[1.3rem] text-[2rem] mb-[1.8rem]'>+1 (707) 681-1531 (International)</h1>
            <h1 className='lg:h1-info font-[700] lg:text-[1.3rem] text-[2rem] mb-[1.8rem]'>+1 (707) 681-1531 (Whatsapp)</h1>
            <h1 className='lg:h1-info font-[700] lg:text-[1.3rem] text-[2rem] mb-[1.8rem]'>hello@codevillage.ng</h1>
          </div>
        </div>
        <Footer/>
      </div>
